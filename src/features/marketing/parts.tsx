  ...
  return (
    <section className="bg-[#152c8f]">
      <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 sm:py-20">
        <h2 className="text-2xl font-semibold tracking-tight text-white sm:text-3xl">Access CostCraft</h2>
        <p className="mx-auto mt-3 max-w-xl text-base text-white/70">
          Authorized Bookends Hospitality users can sign in to manage recipes, costing, yield and
          wastage across every brand and outlet.
        </p>
        <div className="mt-8 flex justify-center">
          <Button asChild size="lg" className="bg-white text-[#152c8f] hover:bg-white/90">
            <Link to={authed ? "/dashboard" : "/login"}>{authed ? "Go to Dashboard" : "Go to Login"}</Link>
          </Button>
        </div>
      </div>
    </section>
