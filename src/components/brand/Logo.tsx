...
// so the mark is the ChefHat glyph in a rounded Bookends-blue tile (matching the
// in-app header). Reused by the public landing header/footer. Drop a real SVG/PNG
// into /public and swap <ChefHat> for an <img> here to use official artwork.
  ...
  return (
    <span
      ...
      className={cn(
        ...
        invert ? "bg-white/15 text-white ring-1 ring-inset ring-white/25" : "bg-primary text-primary-foreground",
        s.box,
        className,
      )}
    >
